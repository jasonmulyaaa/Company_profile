                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="file" class="form-control" @error('image') is-invalid @enderror name="favicon" id="image" onchange="previewImage()">
                                    @error('image')
                      ...
                      <input type="hidden" class="form-control" id="x" placeholder="Metadata" name="metadata">
                      <trix-editor input="x"></trix-editor>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Floating Image</label>
                      <input type="number" class="form-control" id="exampleInputName1" placeholder="No Telepon" name="floatingimg">
                    </div>
