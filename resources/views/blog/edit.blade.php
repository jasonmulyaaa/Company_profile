                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                <strong>Foto</strong>
                                <input type="hidden" name="oldImage" value="{{ $blog->foto }}">
                                @if ($blog->image)
                                    <img src="{{ asset('storage/' . $blog->foto) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">
                                @else
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" class="form-control" id="x" placeholder="Deskripsi" name="deskripsi" value="{{ $blog->deskripsi}}">
