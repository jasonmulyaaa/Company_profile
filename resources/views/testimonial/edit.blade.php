              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputName1" placeholder="Instansi" name="instansi" value="{{ $testimonial->instansi}}">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Isi Testimonial</label>
                      <input type="hidden" class="form-control" id="x" placeholder="Isi Testimonial" name="isi_testimoni" value="{{ $testimonial->isi_testimoni}}">
